...
function CastSpels()
	...
	if UnitCanAttack("player","target") and UnitHealth("target")>0 then 
		...
		if PM>=265 and TH<=378 and ActSpell("Pain Spike","Rank 4",0)==0 then SpellStopCasting(); ActSpell("Pain Spike","Rank 4");end;
