...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and not GDebuff("Spell_Shadow_UnsummonBuilding") then 
		if Act("Vampiric Embrace") then return;end;
	else 
		TargetNearestEnemy();
	end;
else 
