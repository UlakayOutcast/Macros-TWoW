-=Power Word:Shield=- Ранг в зависимости от уровня цели, оставшейся маны и активного Inner Focus
...
if UnitExists("target")~=1 or UnitCanAttack("player","target") then UT="player";else UT="target";end;
//if UnitExists("target")~=1 or UnitCanAttack("player","target") or UnitIsGroupAssistant("target"[, partyCategoryType])~=1 then UT="player";else UT="target";end;
if UL("player")>59 and UL(UT)>53 and ((UM("player")>500) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 10)"); 
else 
	if UL("player")>53 and UL(UT)>47 and ((UM("player")>382) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 9)"); 
	else 
		if UL("player")>47 and UL(UT)>41 and ((UM("player")>355) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 8)"); 
		else 
			if UL("player")>41 and UL(UT)>35 and ((UM("player")>300) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 7)"); 
			else 
				if UL("player")>35 and UL(UT)>29 and ((UM("player")>250) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 6)"); 
				else 
					if UL("player")>29 and UL(UT)>23 and ((UM("player")>210) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 5)"); 
					else 
						if UL("player")>23 and UL(UT)>17 and ((UM("player")>175) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 4)"); 
						else 
							if UL("player")>17 and UL(UT)>11 and ((UM("player")>130) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 3)"); 
							else 
								if UL("player")>11 and UL(UT)>5 and ((UM("player")>80) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 2)"); 
								else 
									if UL("player")>5 and UL(UT)>0 and ((UM("player")>45) or (buffed("Inner Focus")=="buff")) then CS("Power Word: Shield(Rank 1)"); 
									end;
								end;
							end;
						end;
