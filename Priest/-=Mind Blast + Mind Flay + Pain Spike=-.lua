...
function CastSpels()
	...
	if UnitCanAttack("player","target") and UnitHealth("target")>0 then 
		...
		if PM>=205 and ActSpell("Mind Flay","Rank 6") then return;end;
		if PM>=165 and ActSpell("Mind Flay","Rank 5") then return;end;
		if PM>=135 and ActSpell("Mind Flay","Rank 4") then return;end;
		if PM>=100 and ActSpell("Mind Flay","Rank 3") then return;end;
		if PM>=70 and ActSpell("Mind Flay","Rank 2") then return;end;
		if PM>=45 and ActSpell("Mind Flay","Rank 1") then return;end;
	end;
end;
CastSpels();