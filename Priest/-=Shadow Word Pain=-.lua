...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and not GDebuff("Spell_Shadow_ShadowWordPain") then 
		if Act("Shadow Word: Pain") then return;end;
	else 
		TargetNearestEnemy();
	end;
else 
