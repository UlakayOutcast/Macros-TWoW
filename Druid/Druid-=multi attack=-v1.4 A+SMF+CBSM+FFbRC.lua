...
function Attack_Actions() 
	...
	if Aura("Bear Form") or Aura("Cat Form") then 
		...
		if Aura("Bear Form") then 
			...
			if melee() and (PM>=20 or OoC) and ActSpell("Swipe") then end;
