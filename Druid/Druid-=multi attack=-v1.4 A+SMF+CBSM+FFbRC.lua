...
function Attack_Actions() 
	...
	if (Aura("Bear Form") or Aura("Cat Form")) and not GotDebuff("Spell_Shadow_ImpPhaseShift","player") and not GotDebuff("Spell_Holy_Silence","player") then 
