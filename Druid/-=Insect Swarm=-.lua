...
if UnitExists("target")then 
	if ( UnitAffectingCombat("player") and UnitAffectingCombat("target") and not GotDebuff("Spell_Nature_InsectSwarm") ) or not UnitAffectingCombat("player") then 
