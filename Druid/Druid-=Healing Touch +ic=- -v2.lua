...
if not IsAltKeyDown() or not GotSpell() then 
	if UL("player")>59 and ((UM("player")>799 and (AH>2267 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 11") then CastSpellByName("Healing Touch(Rank 11)"); 
	else 
		if UL("player")>55 and ((UM("player")>719 and (AH>1890 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 10") then CastSpellByName("Healing Touch(Rank 10)"); 
		else 
			if UL("player")>49 and ((UM("player")>599 and (AH>1516 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 9") then CastSpellByName("Healing Touch(Rank 9)"); 
			else 
				if UL("player")>43 and ((UM("player")>494 and (AH>1199 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 8") then CastSpellByName("Healing Touch(Rank 8)"); 
				else 
					if UL("player")>37 and ((UM("player")>404 and (AH>936 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 7") then CastSpellByName("Healing Touch(Rank 7)"); 
					else 
						if UL("player")>31 and ((UM("player")>334 and (AH>742 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 6") then CastSpellByName("Healing Touch(Rank 6)"); 
						else 
							if UL("player")>25 and ((UM("player")>269 and (AH>572 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 5") then CastSpellByName("Healing Touch(Rank 5)"); 
							else 
								if UL("player")>19 and ((UM("player")>184 and (AH>363 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 4") then CastSpellByName("Healing Touch(Rank 4)"); 
								else 
									if UL("player")>13 and ((UM("player")>109 and (AH>195 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 3") then CastSpellByName("Healing Touch(Rank 3)"); 
									else 
										if UL("player")>7 and ((UM("player")>54 and (AH>88 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 2") then CastSpellByName("Healing Touch(Rank 2)"); 
										else 
											if UL("player")>0 and ((UM("player")>24 and (AH>37 or inCombat())) or BIF()) and GotSpell("Healing Touch","Rank 1") then CastSpellByName("Healing Touch(Rank 1)"); 
