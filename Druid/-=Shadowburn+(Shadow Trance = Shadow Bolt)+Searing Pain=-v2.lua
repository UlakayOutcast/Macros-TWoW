...
function CastSpels()
	...
	if UnitCanAttack("player","target") and UnitHealth("target")>0 then 
		...
		if nil then CastSpellByName("Searing Pain");end;
	end;
end;
CastSpels();