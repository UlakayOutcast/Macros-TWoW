...
function Attack_Actions() 
	...
	if GotBuff("Ability_Druid_CatForm") then 
		...
		if GotBuff("Ability_Ambush") then 
			...
			if not GotDebuff("Spell_Shadow_ImpPhaseShift","player") and not GotDebuff("Spell_Holy_Silence","player") then 
