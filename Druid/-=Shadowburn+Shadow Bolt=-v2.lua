...
function CastSpels()
	...
	if UnitCanAttack("player","target") and UnitHealth("target")>0 then 
		...
		if nil then CastSpellByName("Shadow Bolt");end;
	end;
end;
CastSpels();