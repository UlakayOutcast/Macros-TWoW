...
function Attack_Actions() 
	...
	if GotBuff("ForceOfNature") then 
		if (GotBuff("StarFire") or GotBuff("NaturesBlessing")) and RPoH>0.2 and action("Starfire") then return;
		else 
