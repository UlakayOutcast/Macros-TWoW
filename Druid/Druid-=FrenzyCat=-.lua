...
function Attack_Actions() 
	...
	if not GotBuff('Ability_Racial_BearForm') then 
		if not GotDebuff('Spell_Nature_StarFall') and (TheMana>TheMaxMana*0.33) then  
			if GotBuff('Ability_Druid_CatForm') and ActSpell("Cat Form") then return;end;
			...
			if not GotBuff('Ability_Racial_BearForm') and not GotBuff('Ability_Druid_CatForm') then ActSpell("Cat Form");end;
		end;
	end;
