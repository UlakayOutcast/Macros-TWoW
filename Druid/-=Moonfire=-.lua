...
if UnitExists("target")then 
	...
	if ( UnitAffectingCombat("player") and UnitAffectingCombat("target") and (not GotDebuff("Spell_Nature_StarFall") or OoC) ) or not UnitAffectingCombat("player") then 
