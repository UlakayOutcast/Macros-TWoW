...
local function CastSpels()
	...
	if UnitCanAttack("player","target") and UnitHealth("target")>0 then 
		...
		if GotSpell("Arcane Surge")~=0 or ArcaneSurg==0 then 
			...
			if PL>=6 and (PM>=40 or CC) and AH>0 and GotSpell("Fire Blast","Rank 1") then CastSpellByName("Fire Blast(Rank 1)");return;end;
		else 
			if PL>=56 and (PM>=170 or CC) and AH>613 and GotSpell("Arcane Surge","Rank 4") then CastSpellByName("Arcane Surge(Rank 4)");ArcaneSurg=0;return;end;
			if PL>=48 and (PM>=140 or CC) and AH>475 and GotSpell("Arcane Surge","Rank 3") then CastSpellByName("Arcane Surge(Rank 3)");ArcaneSurg=0;return;end;
			if PL>=40 and (PM>=110 or CC) and AH>350 and GotSpell("Arcane Surge","Rank 2") then CastSpellByName("Arcane Surge(Rank 2)");ArcaneSurg=0;return;end;
			if PL>=32 and (PM>=85 or CC) and AH>0 and GotSpell("Arcane Surge","Rank 1") then CastSpellByName("Arcane Surge(Rank 1)");ArcaneSurg=0;return;end;
		end;
	end;
end;
CastSpels();