-=Holy Light=- SuperMacro. Rank в зависимости от уровня играка и его маны.
...
-=Holy Light=- Rank в зависимости от уровня играка, его маны и отсутствующего здоровья цели.
С зажатым Alt используется "Divine Favor"
...
while(SW>0) do 
	if IsAltKeyDown()==nil or SW==2 then 
		if UL("player")>60 and UM("player")>659 and AH>1771 then CastSpellByName("Holy Light(Rank 9)");
		else 
			if UL("player")>53 and UM("player")>579 and AH>1389 then CastSpellByName("Holy Light(Rank 8)");
			else 
				if UL("player")>45 and UM("player")>464 and AH>1054 then CastSpellByName("Holy Light(Rank 7)");
				else 
					if UL("player")>37 and UM("player")>364 and AH>781 then CastSpellByName("Holy Light(Rank 6)");
					else 
						if UL("player")>29 and UM("player")>274 and AH>554 then CastSpellByName("Holy Light(Rank 5)");
						else 
							if UL("player")>21 and UM("player")>189 and AH>357 then CastSpellByName("Holy Light(Rank 4)");
							else 
								if UL("player")>13 and UM("player")>109 and AH>188 then CastSpellByName("Holy Light(Rank 3)");
								else 
									if UL("player")>5 and UM("player")>59 and AH>91 then CastSpellByName("Holy Light(Rank 2)");
									else 
										if UL("player")>0 and UM("player")>34 and AH>48 then CastSpellByName("Holy Light(Rank 1)");
										end;
									end;
								end;
							end;
