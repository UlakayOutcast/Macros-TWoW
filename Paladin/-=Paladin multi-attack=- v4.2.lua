...
function Attack_Actions() 
	...
	if not GotBuff("HolySmite") and not GotBuff("HealingAura") and (not GotBuff("RighteousnessAura") or mana>0.75) and not GotBuff("SealOfWrath") and not GotBuff("InnerRage") and not GotBuff("ThunderBolt") then 
