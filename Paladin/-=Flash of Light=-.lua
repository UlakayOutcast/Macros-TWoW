-=Flash of Lightt=- SuperMacro. Rank в зависимости от уровня играка и его маны. С зажатым Alt используется "Nature's Swiftness"
...
-=Flash of Light=- Rank в зависимости от уровня играка, его маны и отсутствующего здоровья цели. С зажатым Alt используется "Divine Favor"

/script local UL=UnitLevel;local UM=UnitMana;local UT,AH;local SW=1;if UL("target")==0 or UnitCanAttack("player","target") then UT="player";else UT="target";end;AH=UnitHealthMax(UT)-UnitHealth(UT);while(SW>0) do if IsAltKeyDown()==nil or SW==2 then if UL("player")>57 and UM("player")>139 and AH>348 then CastSpellByName("Flash of Light(Rank 6)");else if UL("player")>49 and UM("player")>114 and AH>278 then CastSpellByName("Flash of Light(Rank 5)");else if UL("player")>41 and UM("player")>89 and AH>206 then CastSpellByName("Flash of Light(Rank 4)");else if UL("player")>33 and UM("player")>69 and AH>153 then CastSpellByName("Flash of Light(Rank 3)");else if UL("player")>25 and UM("player")>49 and AH>102 then CastSpellByName("Flash of Light(Rank 2)");else if UL("player")>19 and UM("player")>34 and AH>67 then CastSpellByName("Flash of Light(Rank 1)");end;end;end;end;end;end;SW=0;else CastSpellByName("Divine Favor");SW=2;end;end;
