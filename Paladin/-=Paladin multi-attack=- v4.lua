...
function Attack_Actions() 
	...
	if  melee() and (Aura()=="Sanctity Aura" or Aura()=="Retribution Aura") and mana> 0.2 and ActSpell("Consecration") then return; end;
	if melee() and mana>0.1 then 
