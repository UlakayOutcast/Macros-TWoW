...
function Attack_Actions() 
	...
	if (Aura()=="Sanctity Aura" or Aura()=="Retribution Aura") and ActSpell("Consecration") then return; end;
	...
	if melee() and mana>0.1 then 
		...
		if random(0,2+CS)<=1 then if ActSpell("Crusader Strike") then return;end; else if ActSpell("Holy Strike") then return;end;end;
	end;
end;
Attack_Actions() 
