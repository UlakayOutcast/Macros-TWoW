...
function Attack_Actions() 
	...
	if melee() and mana>0.1 then 
		if (GotBuff('AuraOfLight') or GotBuff('MindVision') or GotBuff('MindSooth') or GotBuff('DevotionAura') or GotBuff('SealOfKings') or GotBuff('WizardMark') or GotBuff('SealOfFire')) 
			and (not GotDebuff('HealingAura') and not GotDebuff('RighteousnessAura') 
	...
	if melee() and mana>0.1 and action("Crusader Strike") then return end 
