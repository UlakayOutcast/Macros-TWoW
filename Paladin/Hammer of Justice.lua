...
if UnitMana("player")>89 and GotSpell("Hammer of Justice","Rank 4") then CastSpellByName("Hammer of Justice(Rank 4)");
	...
	if UnitMana("player")>69 and GotSpell("Hammer of Justice","Rank 3") then CastSpellByName("Hammer of Justice(Rank 3)");
		...
		if UnitMana("player")>49 and GotSpell("Hammer of Justice","Rank 2") then CastSpellByName("Hammer of Justice(Rank 2)");
			...
			if UnitMana("player")>35 and GotSpell("Hammer of Justice","Rank 1") then CastSpellByName("Hammer of Justice");
			else CastSpellByName("Hammer of Justice");
			end;
		end;
	end;
end;
...
/script local M,P,C,Sp=UnitMana,"player",CastSpellByName,"Hammer of Justice";if M(P)>99 then C(Sp.."(Rank 4)");else if M(P)>74 then C(Sp.."(Rank 3)");else if M(P)>49 then C(Sp.."(Rank 2)");else CastSpellByName("Hammer of Justice");end;end;end;
