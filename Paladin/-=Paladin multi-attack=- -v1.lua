...
function Attack_Actions() 
	...
	if mana>0.1 and ((not GotDebuff('HolySmite') and not GotDebuff('HealingAura') and not GotDebuff('RighteousnessAura') and not GotDebuff('SealOfWrath') 
	and not GotBuff('HolySmite') and not GotBuff('HealingAura') and not GotBuff('RighteousnessAura') and not GotBuff('SealOfWrath') and not GotBuff('InnerRage') and not GotBuff('ThunderBolt')) 
	or ((GotDebuff('HolySmite') or GotDebuff('HealingAura') or GotDebuff('RighteousnessAura') or GotDebuff('SealOfWrath')) 
	and not GotBuff('HolySmite') and not GotBuff('HealingAura') and not GotBuff('RighteousnessAura') and not GotBuff('SealOfWrath') and not GotBuff('InnerRage') and not GotBuff('ThunderBolt'))) then 
