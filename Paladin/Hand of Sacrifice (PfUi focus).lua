...
function CastSpel() 
	...
	if UnitInParty("target") and not UnitIsUnit("target","player") and not GBuff("Spell_Holy_SealOfSacrifice") then 
		CastSpellByName("Hand of Sacrifice");
	else 
