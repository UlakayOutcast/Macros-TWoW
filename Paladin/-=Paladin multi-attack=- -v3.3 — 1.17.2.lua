...
function Attack_Actions() 
	...
	then 
		if (GotBuff('AuraOfLight')) and action("Blessing of Might") then return else 
			if (GotBuff('MindSooth') or GotBuff('MindVision')) and action("Blessing of Wisdom") then return else 
