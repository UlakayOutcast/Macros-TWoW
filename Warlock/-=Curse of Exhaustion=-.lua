...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and not GDebuff("Spell_Shadow_GrimWard") then 
		if Act("Curse of Exhaustion") then return;end;
	else 
		TargetNearestEnemy();
	end;
else 
