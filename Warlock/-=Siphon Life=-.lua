...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and not GDebuff("Spell_Shadow_Requiem") then 
		if Act("Siphon Life") then return;end;
	else 
		TargetNearestEnemy();
	end;
else 
