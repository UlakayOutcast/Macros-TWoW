...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and (not GDebuff("Spell_Shadow_ChillTouch") or (Melediction and not GDebuff("Spell_Shadow_CurseOfSargeras"))) then 
		if Act("Curse of the Elements") then return;end;
	else 
		TargetNearestEnemy();
	end;
else 
