...
if UH<=503+random(503) and PM>=365*TR and GotSpell("Shadowburn","Rank 6") and UnitIsTrivial("target") then CastSpellByName("Shadowburn(Rank 6)"); 
else 
	if UH<=393+random(393) and PM>=305*TR and GotSpell("Shadowburn","Rank 5") and UnitIsTrivial("target") then CastSpellByName("Shadowburn(Rank 5)"); 
	else 
		if UH<=294+random(294) and PM>=245*TR and GotSpell("Shadowburn","Rank 4") and UnitIsTrivial("target") then CastSpellByName("Shadowburn(Rank 4)"); 
		else 
			if UH<=211+random(211) and PM>=190*TR and GotSpell("Shadowburn","Rank 3") and UnitIsTrivial("target") then CastSpellByName("Shadowburn(Rank 3)"); 
			else 
				if UH<=132+random(132) and PM>=130*TR and GotSpell("Shadowburn","Rank 2") and UnitIsTrivial("target") then CastSpellByName("Shadowburn(Rank 2)"); 
				else 
					if UH<=100+random(100) and PM>=105*TR and GotSpell("Shadowburn","Rank 1") and UnitIsTrivial("target") then CastSpellByName("Shadowburn(Rank 1)"); 
					else 
