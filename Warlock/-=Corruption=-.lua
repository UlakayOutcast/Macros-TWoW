...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and not GDebuff("Spell_Shadow_AbominationExplosion") then 
		if Act("Corruption") then return;end;
	else 
		TargetNearestEnemy();
	end;
else 
