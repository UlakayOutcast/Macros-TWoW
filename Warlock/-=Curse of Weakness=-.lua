...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and not GDebuff("Spell_Shadow_CurseOfMannoroth") then 
		if Act("Curse of Weakness") then TargetNearestEnemy();end;
	else 
		TargetNearestEnemy();
	end;
else 
