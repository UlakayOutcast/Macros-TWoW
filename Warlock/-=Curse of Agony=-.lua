...
if UnitAffectingCombat("player") then 
	if UnitAffectingCombat("target") and not GDebuff("Spell_Shadow_CurseOfSargeras") then 
		if Act("Curse of Agony") then return;end;
	else 
		TargetNearestEnemy();
	end;
else 
