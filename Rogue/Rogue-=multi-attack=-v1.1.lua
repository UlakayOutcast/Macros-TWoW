...
function Attack_Actions() 
	...
	if not GotBuff('Stealth') then 
		...
		if melee() then 
			...
			if mana>=10 and action("Surprise Attack") then end;
			if mana>=10 and action("Riposte") then end;
		end;
	end;
end;
Attack_Actions() 