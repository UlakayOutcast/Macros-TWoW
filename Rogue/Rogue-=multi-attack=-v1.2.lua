...
function Attack_ActSpells() 
	...
	if melee() then  
		if GotBuff("Stealth") then 
			...
			and PM>=20 and not GotDebuff("Ability_Rogue_Rupture") and (GetComboPoints()*20>=math.random(100-(100*TPoH),100)) and ActSpell("Rupture") then return; end;
			if PM>=30 and GetComboPoints()*20>=math.random(100*TPoH,101) and ActSpell("Eviscerate") then return; end;
			...
			if PM>=60 and ActSpell("Noxious Assault") then return end;
