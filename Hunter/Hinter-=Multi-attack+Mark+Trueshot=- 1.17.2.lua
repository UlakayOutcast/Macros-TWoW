...
function Attack_Actions() 
	...
	if melee() then 
		...
		if not GotBuff("WhiteDireWolf") and not GotBuff("AspectOfTheMonkey") and not GotBuff("RavenForm") then if not ActSpell("Aspect of the Wolf") then ActSpell("Aspect of the Monkey"); end; end;
		ActSpell("Wing Clip");ActSpell("Mongoose Bite");ActSpell("Raptor Strike");return;
	end 
	if ranged() then 
		...
		if not GotBuff("RavenForm") and not GotBuff("WhiteDireWolf") and not GotBuff("AspectOfTheMonkey") and not GotBuff("JungleTiger") then ActSpell("Aspect of the Hawk") end;
		...
		if itemtype == "Bows" or itemtype == "Guns" or itemtype == "Crossbows" then 
			...
			if ActSpell("Steady Shot") then return;end;
		end;
