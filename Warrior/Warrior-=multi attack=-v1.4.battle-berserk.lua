...
function Attack_Acts() 
	...
	if melee()and not GBuff("Ability_Whirlwind")then 
		...
		if HW("Shields")and mana>=25 and Act("Shield Slam") then if GAI then Outfitter_ExecuteCommand("wear OHW");return;end;end;
		...
		if GS~="Berserker Stance"and mana>=25 and not HW("Shields")and Act("Shield Slam",0)<=1 then if GAI then Outfitter_ExecuteCommand("wear OHS");return;end;end;
		if GS=="Defensive Stance"and HW("Shields")and mana>=10 and Act("Shield Block")then return;end;
		if GS~="Defensive Stance"and HW("MainH")and mainSpeed>=2.4-(TRSlam*0.25)and mainSpeed<=2.6-(TRSlam*0.25)and (not HW("OffH")or (HW("OffH")and offSpeed>=2.4-(TRSlam*0.25)and offSpeed<=2.6-(TRSlam*0.25)))and mana>=15+(TRTM*5) and Act("Slam")then return;end;
