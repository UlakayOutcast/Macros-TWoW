...
function Attack_Acts() 
	...
	if melee()and not GBuff("Ability_Whirlwind")then 
		...
		if GS~="Defensive Stance"and HW("MainH")and mainSpeed>=2.4-(TRSlam*0.25)and mainSpeed<=2.6-(TRSlam*0.25)and mana>=15+(TRTM*5) and Act("Slam")then return;end;
