...
function Attack_Acts() 
	...
	if melee()and not GBuff("Ability_Whirlwind")then 
		...
		if HW("Shields")and mana>=20 and Act("Shield Slam") then if GAI then Outfitter_ExecuteCommand("wear OHW");return;end;end;
		...
		if mana>=20 and not HW("Shields")and Act("Shield Slam",0)<=1 then if GAI then Outfitter_ExecuteCommand("wear OHS");return;end;end;
